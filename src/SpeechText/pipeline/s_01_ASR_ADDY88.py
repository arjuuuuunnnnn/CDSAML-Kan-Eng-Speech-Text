...
# STAGE_NAME = "Audio Transcription and WER Calculation Stage"
# os.makedirs("../../artifacts/STAGE_01", exist_ok=True)


# class AudioTranscriptionWER:
#     def __init__(self, audio_file, original_transcript_file, output_dir, model_id):
#         self.audio_file = audio_file
#         self.original_transcript_file = original_transcript_file
...
#         output_file = os.path.join(self.output_dir, "01_transcription.txt")
#         with open(output_file, "w", encoding="utf-8") as f:
#             f.write(transcription)
#         logger.info(f"Transcription saved to: {output_file}")

#     def calculate_wer(self, transcription):
#         with open(self.original_transcript_file, "r", encoding="utf-8") as f:
#             original_transcript = f.read().strip()
#         return jiwer.wer(original_transcript, transcription)
...
#         wer = self.calculate_wer(cleaned_transcription)
#         logger.info(f"Word Error Rate (WER): {wer}")

# if __name__ == "__main__":
#     try:
#         logger.info(f"********** stage {STAGE_NAME} started **********")
#         audio_file = "../../artifacts/STAGE_00/Cleaned_denoiser_facebook_1audio.mp3"
#         original_transcript_file = "Kannada_Input_Transcript3.txt"
#         output_dir = "../../artifacts/STAGE_01"
#         model_id = "addy88/wav2vec2-kannada-stt"

#         obj = AudioTranscriptionWER(audio_file, original_transcript_file, output_dir, model_id)
#         obj.main()
